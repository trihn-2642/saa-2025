  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{
          background:
            "linear-gradient(180deg, #fff 0%, color-mix(in srgb, #fff 10%, transparent) 100%)",
        }}
      />
      {/* lit digit */}
      <span
        className={
          compact
            ? "relative z-10 font-digital text-5xl leading-none text-white"
            : "relative z-10 font-digital text-[58px] leading-none text-white sm:text-[74px]"
        }
      >
        {char}
      </span>
